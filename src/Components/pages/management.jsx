...
import { ForManagement } from '../../ArrayFlies/AboutTxtImg';
import { ManagementVideo } from '../../ArrayFlies/VideosList';
...
function Management() {
    ...
    const forManagement = ForManagement();
    const managementVideos = ManagementVideo();
        ...
        <React.Fragment>
            <div className="categories_page">
                <div className="categories_page_section">
                    {forManagement.map((element, index) => {
                ...
                <div className="video-container">
                    <h4>{`Top ${managementVideos.length} Online Management Courses `}</h4>
                    <div className="row" ref={videoListRef}>
                        {managementVideos.map((element) => {
