...
import { ForEngineering } from '../../ArrayFlies/AboutTxtImg';
import { EngineeringVideo } from '../../ArrayFlies/VideosList';
...
function Engineering() {
    ...
    const forEngineering = ForEngineering();
    const engineeringVideos = EngineeringVideo();
        ...
        <React.Fragment>
            <div className="categories_page">
                <div className="categories_page_section">
                    {forEngineering.map((element, index) => {
                ...
                <div className="video-container">
                    <h4>{`Top ${engineeringVideos.length} Online Engineering & Construction Courses `}</h4>
                    <div className="row" ref={videoListRef}>
                        {engineeringVideos.map((element) => {
