...
import { ForDiplomas } from '../../ArrayFlies/AboutTxtImg';
import { DiplomaVideo } from '../../ArrayFlies/VideosList';
...
function Diplomas() {
    ...
    const forDiplomas = ForDiplomas();
    const diplomaVideos = DiplomaVideo();
