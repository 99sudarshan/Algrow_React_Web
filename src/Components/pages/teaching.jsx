...
import { ForTeaching } from '../../ArrayFlies/AboutTxtImg';
import { TeachingVideo } from './../../ArrayFlies/VideosList';
...
const Teaching = () => {
    ...
    const forTeaching = ForTeaching();
    const teachingVideos = TeachingVideo();
        ...
        <React.Fragment>
            <div className="categories_page">
                ...
                <div className="video-container">
                    <h4>{`Top ${teachingVideos.length} Online Teaching & Academics Courses `}</h4>
                    <div className="row" ref={videoListRef}>
                        {teachingVideos.map((element) => {
