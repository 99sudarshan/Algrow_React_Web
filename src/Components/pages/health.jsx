...
import { ForHealth } from '../../ArrayFlies/AboutTxtImg';
import { HealthVideo } from '../../ArrayFlies/VideosList';
        ...
        <React.Fragment>
            <div className="categories_page">
                ...
                <div className="video-container">
                    <h4>{`Top ${healthVideos.length} Online Health Courses `}</h4>
                    <div className="row" ref={videoListRef}>
                        {healthVideos.map((element) => {
