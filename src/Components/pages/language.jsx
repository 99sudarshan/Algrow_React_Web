...
import { ForLanguage } from '../../ArrayFlies/AboutTxtImg';
import VideoCard from '../common/VideoCard';
import { LanguageVideo } from '../../ArrayFlies/VideosList';
        ...
        <React.Fragment>
            <div className="categories_page">
                ...
                <div className="video-container">
                    <h4>{`Top ${LanguageVideos.length} Online Language Courses `}</h4>
                    <div className="row" ref={videoListRef}>
                        {LanguageVideos.map((element) => {
