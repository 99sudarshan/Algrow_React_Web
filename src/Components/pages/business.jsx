...
import { ForBusiness } from '../../ArrayFlies/AboutTxtImg';
import { BusinessVideo } from '../../ArrayFlies/VideosList';
        ...
        <React.Fragment>
            <div className="categories_page">
                ...
                <div className="video-container">
                    <h4>{`Top ${businessVideos.length} Online Business Courses `}</h4>
                    <div className="row" ref={videoListRef}>
                        {businessVideos.map((element) => {
